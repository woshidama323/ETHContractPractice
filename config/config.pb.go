...
// ConfigUpdateClient is the client API for ConfigUpdate service.
//
...
func NewConfigUpdateClient(cc grpc.ClientConnInterface) ConfigUpdateClient {
	return &configUpdateClient{cc}
}

func (c *configUpdateClient) ReloadConfig(ctx context.Context, in *Message, opts ...grpc.CallOption) (*Message, error) {
	out := new(Message)
	err := c.cc.Invoke(ctx, "/main.ConfigUpdate/ReloadConfig", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UnimplementedConfigUpdateServer struct {
}
...
func RegisterConfigUpdateServer(s *grpc.Server, srv ConfigUpdateServer) {
	s.RegisterService(&_ConfigUpdate_serviceDesc, srv)
}

func _ConfigUpdate_ReloadConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Message)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConfigUpdateServer).ReloadConfig(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.ConfigUpdate/ReloadConfig",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConfigUpdateServer).ReloadConfig(ctx, req.(*Message))
	}
